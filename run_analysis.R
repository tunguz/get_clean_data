# Read the y_test.txt into a table

y_test_table <- read.table("./data/test/y_test.txt")

# Read the subject_test.txt into a table

subject_test_table <- read.table("./data/test/subject_test.txt")
